...
export default function CircleCard({
  ...
  return (
    <Card
      className='overflow-hidden rounded-xl relative min-w-full min-w-[300px]'
      sx={{ maxWidth: 345 }}
    ...
    <CardActionArea href={'/circle/' + circle_id}>
      ...
      <ListOfUsers open={openMembers} onClose={toggleMembers} userList={usersList} />
      <ListOfNextEvents open={openEvents} onClose={toggleEvents} eventsList={eventsList} />
    </Card>
  );
}
